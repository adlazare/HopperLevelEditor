...
public class LevelObject : MonoBehaviour {
	...
	public enum LevelObjectType{Box1, Set1Spinner, Plank, Spring, Coin, Wall, PlankJr, Set1WoodBlock, Set1Spring, Set1Plank, Set1Wall, Set1EndBox, 
		...
		Set2Plank1,Set2Plank2,Set2WoodBlock,Set2Spring,Set2DangerNail1,Set2DangerNail2,Set2SafeNail1,Set2SafeNail2,Set2Spinner,Set2Wall,Set2Spring2,Set2MovingBlock,Set2MovingBlockReverse,Set2Trunk };
...
//		snapToGrid();
	...
	public static string getObjectNameByObjectType(LevelObjectType lot)
	{
		...
		case LevelObjectType.Set2WoodBlock:
			...
			break;
		case LevelObjectType.Set2Spring:
			return "Set2Spring";
			break;
		case LevelObjectType.Set2DangerNail1:
			return "Set2DangerNail1";
			break;
		case LevelObjectType.Set2DangerNail2:
			return "Set2DangerNail2";
			break;
		case LevelObjectType.Set2SafeNail1:
			return "Set2SafeNail1";
			break;
		case LevelObjectType.Set2SafeNail2:
			return "Set2SafeNail2";
			break;
		case LevelObjectType.Set2Spinner:
			return "Set2Spinner";
			break;
		case LevelObjectType.Set2Wall:
			return "Set2Wall";
			break;
		case LevelObjectType.Set2Spring2:
			return "Set2Spring2";
			break;
		case LevelObjectType.Set2MovingBlock:
			return "Set2MovingBlock";
			break;
		case LevelObjectType.Set2MovingBlockReverse:
			return "Set2MovingBlockReverse";
			break;
		case LevelObjectType.Set2Trunk:
			return "Set2Trunk";
			break;
		default:
			return "";
